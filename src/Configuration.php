...
class Configuration
{
    ...
    /**
     * User agent of the HTTP request, set to "BingAdsSDKPHP.RestApi 13.0.28" by default
     *
     * @var string
     */
    protected string $userAgent = 'BingAdsSDKPHP.RestApi 13.0.28 ' . PHP_VERSION;
    ...
    public static function toDebugReport(): string
    {
        ...
        $report .= '    SDK Package Version: 13.0.28' . PHP_EOL;
