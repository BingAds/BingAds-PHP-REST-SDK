...
class BroadMatchKeywordOpportunity extends KeywordOpportunity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BroadMatchKeywordOpportunity';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('Type', $data ?? [], 'BroadMatchKeywordOpportunity');
    }
