...
class RecommendationBaseBase extends RecommendationBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RecommendationBaseBase';
