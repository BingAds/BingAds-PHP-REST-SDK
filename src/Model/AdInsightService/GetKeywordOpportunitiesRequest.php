...
class GetKeywordOpportunitiesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetKeywordOpportunitiesRequest';
    ...
    protected static array $openAPITypes = [
        'AdGroupId' => 'string',
        'CampaignId' => 'string',
        'OpportunityType' => '\Microsoft\MsAds\Rest\Model\AdInsightService\KeywordOpportunityType'
    ];
    ...
    */
     ...
     *
     * @return \Microsoft\MsAds\Rest\Model\AdInsightService\KeywordOpportunityType|mixed|null
     */
     ...
     *
     * @param \Microsoft\MsAds\Rest\Model\AdInsightService\KeywordOpportunityType|mixed|null $OpportunityType OpportunityType
     *
     * @return self
     */
    public function setOpportunityType($OpportunityType)
    {
        ...
        if (!$OpportunityType instanceof \Microsoft\MsAds\Rest\Model\AdInsightService\KeywordOpportunityType) {
            $OpportunityType = new \Microsoft\MsAds\Rest\Model\AdInsightService\KeywordOpportunityType($OpportunityType);
        }
