...
class CampaignBidLandscapeType
{
    /**
     * Possible values of this enum
     */
    public const ECPC_CAMPAIGN_WIDE_BID = 'Ecpc_CampaignWideBid';

    public const ECPC_BID_SCALING = 'Ecpc_BidScaling';
    ...
    {
        return [
            self::ECPC_CAMPAIGN_WIDE_BID,
            self::ECPC_BID_SCALING,
            self::TARGET_CPA,
            self::TARGET_ROAS
        ];
    }
