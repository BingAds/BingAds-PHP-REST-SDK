...
class DayMonthAndYear implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DayMonthAndYear';
    ...
    */
    ...
    {
        if (!isset($this->container['Month']) || is_null($this->container['Month'])) {
            return null;
        }
    ...
    {
        if (!isset($this->container['Year']) || is_null($this->container['Year'])) {
            return null;
        }
