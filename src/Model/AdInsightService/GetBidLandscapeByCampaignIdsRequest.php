...
class GetBidLandscapeByCampaignIdsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetBidLandscapeByCampaignIdsRequest';
