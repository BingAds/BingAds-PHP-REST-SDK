...
class GetAudienceBreakdownRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetAudienceBreakdownRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'Lcid' => 'int',
        'BreakdownReturnCategory' => '\Microsoft\MsAds\Rest\Model\AdInsightService\BreakdownCategory',
        'MultiAdTypes' => 'int'
    ];
    ...
    protected static array $setters = [
        ...
        'Feed' => 'setFeed',
        'Lcid' => 'setLcid',
        'BreakdownReturnCategory' => 'setBreakdownReturnCategory',
    ...
    protected static array $getters = [
        ...
        'Feed' => 'getFeed',
        'Lcid' => 'getLcid',
        'BreakdownReturnCategory' => 'getBreakdownReturnCategory',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('BreakdownReturnCategory', $data ?? [], null);
    ...
    */
    ...
    {
        if (is_null($Lcid)) {
            array_push($this->openAPINullablesSetToNull, 'Lcid');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('Lcid', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets BreakdownReturnCategory
     *
     * @return \Microsoft\MsAds\Rest\Model\AdInsightService\BreakdownCategory|mixed|null
     */
    public function getBreakdownReturnCategory()
    {
        if (!isset($this->container['BreakdownReturnCategory']) || is_null($this->container['BreakdownReturnCategory'])) {
            return null;
        }
        if ((is_object($this->container['BreakdownReturnCategory']) || is_string($this->container['BreakdownReturnCategory'])) && method_exists($this->container['BreakdownReturnCategory'], 'getValue')) {
            return $this->container['BreakdownReturnCategory']->getValue();
        }
        return $this->container['BreakdownReturnCategory'];
    }

    /**
     * Sets BreakdownReturnCategory
     *
     * @param \Microsoft\MsAds\Rest\Model\AdInsightService\BreakdownCategory|mixed|null $BreakdownReturnCategory BreakdownReturnCategory
     *
     * @return self
     */
    public function setBreakdownReturnCategory($BreakdownReturnCategory)
    {
        if (is_null($BreakdownReturnCategory)) {
            throw new \InvalidArgumentException('non-nullable BreakdownReturnCategory cannot be null');
        }
        if (!$BreakdownReturnCategory instanceof \Microsoft\MsAds\Rest\Model\AdInsightService\BreakdownCategory) {
            $BreakdownReturnCategory = new \Microsoft\MsAds\Rest\Model\AdInsightService\BreakdownCategory($BreakdownReturnCategory);
        }
        $this->container['BreakdownReturnCategory'] = $BreakdownReturnCategory;
