...
class EntityDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'EntityDetail';
    ...
    */
    ...
    {
        if (!isset($this->container['EntityName']) || is_null($this->container['EntityName'])) {
            return null;
        }
