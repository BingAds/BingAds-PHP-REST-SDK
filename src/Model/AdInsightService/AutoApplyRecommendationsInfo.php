...
class AutoApplyRecommendationsInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AutoApplyRecommendationsInfo';
    ...
    protected static array $setters = [
        ...
        'AAROptInStatus' => 'setAAROptInStatus'
    ];
    ...
    protected static array $getters = [
        ...
        'AAROptInStatus' => 'getAAROptInStatus'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('AAROptInStatus', $data ?? [], null);
    }
    ...
    */
     ...
     * @return bool|null
     */
    public function getAAROptInStatus()
    {
        if (!isset($this->container['AAROptInStatus']) || is_null($this->container['AAROptInStatus'])) {
            return null;
        }
        return $this->container['AAROptInStatus'];
    }

    /**
     * Sets AAROptInStatus
     *
     * @param bool|null $AAROptInStatus AAROptInStatus
     *
     * @return self
     */
    public function setAAROptInStatus($AAROptInStatus)
    {
        if (is_null($AAROptInStatus)) {
            throw new \InvalidArgumentException('non-nullable AAROptInStatus cannot be null');
        }
        $this->container['AAROptInStatus'] = $AAROptInStatus;
