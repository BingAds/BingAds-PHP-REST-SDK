...
class CompetitionSearchParameter extends SearchParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CompetitionSearchParameter';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('Type', $data ?? [], 'CompetitionSearchParameter');
    }
