...
class KeywordOpportunityBase extends KeywordOpportunity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'KeywordOpportunityBase';
