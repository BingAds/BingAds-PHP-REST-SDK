...
class GetEstimatedPositionByKeywordIdsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetEstimatedPositionByKeywordIdsRequest';
