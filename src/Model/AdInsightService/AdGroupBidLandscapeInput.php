...
class AdGroupBidLandscapeInput implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AdGroupBidLandscapeInput';
