...
class SearchVolumeSearchParameter extends SearchParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SearchVolumeSearchParameter';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('Type', $data ?? [], 'SearchVolumeSearchParameter');
    }
    ...
    */
     ...
     * Sets Minimum
     *
     * @param string|null $Minimum Minimum
     *
     * @return self
     */
     ...
     * Sets Maximum
     *
     * @param string|null $Maximum Maximum
     *
     * @return self
     */
