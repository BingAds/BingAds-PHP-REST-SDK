...
class KeywordAndConfidence implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'KeywordAndConfidence';
    ...
    */
    ...
    {
        if (!isset($this->container['ConfidenceScore']) || is_null($this->container['ConfidenceScore'])) {
            return null;
        }
     ...
     *
     * @param float|null $ConfidenceScore ConfidenceScore
     *
     * @return self
     */
    public function setConfidenceScore($ConfidenceScore)
    {
        if (is_null($ConfidenceScore)) {
            throw new \InvalidArgumentException('non-nullable ConfidenceScore cannot be null');
        }
