...
class CampaignBudgetRecommendation extends RecommendationBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CampaignBudgetRecommendation';
