...
class KeywordLocation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'KeywordLocation';
    ...
    */
    ...
    {
        if (!isset($this->container['Percentage']) || is_null($this->container['Percentage'])) {
            return null;
        }
