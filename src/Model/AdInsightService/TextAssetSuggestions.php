...
class TextAssetSuggestions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'TextAssetSuggestions';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('TextAssets', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (!isset($this->container['TextAssets']) || is_null($this->container['TextAssets'])) {
            return null;
        }
        return $this->container['TextAssets'];
    }

    /**
     * Sets TextAssets
     *
     * @param string[]|null $TextAssets TextAssets
     *
     * @return self
     */
    public function setTextAssets($TextAssets)
    {
        if (is_null($TextAssets)) {
            array_push($this->openAPINullablesSetToNull, 'TextAssets');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('TextAssets', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['TextAssets'] = $TextAssets;
