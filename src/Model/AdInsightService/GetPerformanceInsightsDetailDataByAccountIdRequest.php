...
class GetPerformanceInsightsDetailDataByAccountIdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetPerformanceInsightsDetailDataByAccountIdRequest';
