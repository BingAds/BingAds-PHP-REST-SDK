...
class EstimatedBidAndTraffic implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'EstimatedBidAndTraffic';
    ...
    protected static array $openAPINullables = [
        'MinClicksPerWeek' => true,
        'MaxClicksPerWeek' => true,
        'AverageCPC' => true,
        'MinImpressionsPerWeek' => true,
        'MaxImpressionsPerWeek' => true,
        'CTR' => true,
        'MinTotalCostPerWeek' => true,
        'MaxTotalCostPerWeek' => true,
        'CurrencyCode' => false,
        'MatchType' => false,
        'EstimatedMinBid' => false
    ];
    ...
    protected static array $setters = [
        ...
        'EstimatedMinBid' => 'setEstimatedMinBid'
    ];
    ...
    protected static array $getters = [
        ...
        'EstimatedMinBid' => 'getEstimatedMinBid'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('EstimatedMinBid', $data ?? [], null);
    }
    ...
    */
    ...
    public function setMinClicksPerWeek($MinClicksPerWeek)
    {
        if (is_null($MinClicksPerWeek)) {
            array_push($this->openAPINullablesSetToNull, 'MinClicksPerWeek');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('MinClicksPerWeek', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    public function setMaxClicksPerWeek($MaxClicksPerWeek)
    {
        if (is_null($MaxClicksPerWeek)) {
            array_push($this->openAPINullablesSetToNull, 'MaxClicksPerWeek');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('MaxClicksPerWeek', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setAverageCPC($AverageCPC)
    {
        if (is_null($AverageCPC)) {
            array_push($this->openAPINullablesSetToNull, 'AverageCPC');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('AverageCPC', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setMinImpressionsPerWeek($MinImpressionsPerWeek)
    {
        if (is_null($MinImpressionsPerWeek)) {
            array_push($this->openAPINullablesSetToNull, 'MinImpressionsPerWeek');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('MinImpressionsPerWeek', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setMaxImpressionsPerWeek($MaxImpressionsPerWeek)
    {
        if (is_null($MaxImpressionsPerWeek)) {
            array_push($this->openAPINullablesSetToNull, 'MaxImpressionsPerWeek');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('MaxImpressionsPerWeek', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setMinTotalCostPerWeek($MinTotalCostPerWeek)
    {
        if (is_null($MinTotalCostPerWeek)) {
            array_push($this->openAPINullablesSetToNull, 'MinTotalCostPerWeek');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('MinTotalCostPerWeek', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setMaxTotalCostPerWeek($MaxTotalCostPerWeek)
    {
        if (is_null($MaxTotalCostPerWeek)) {
            array_push($this->openAPINullablesSetToNull, 'MaxTotalCostPerWeek');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('MaxTotalCostPerWeek', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    /**
     * Gets EstimatedMinBid
     *
     * @return float|null
     */
    public function getEstimatedMinBid()
    {
        if (!isset($this->container['EstimatedMinBid']) || is_null($this->container['EstimatedMinBid'])) {
            return null;
        }
        return $this->container['EstimatedMinBid'];
    }

    /**
     * Sets EstimatedMinBid
     *
     * @param float|null $EstimatedMinBid EstimatedMinBid
     *
     * @return self
     */
    public function setEstimatedMinBid($EstimatedMinBid)
    {
        if (is_null($EstimatedMinBid)) {
            throw new \InvalidArgumentException('non-nullable EstimatedMinBid cannot be null');
        }
        $this->container['EstimatedMinBid'] = $EstimatedMinBid;
