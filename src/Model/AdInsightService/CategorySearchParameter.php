...
class CategorySearchParameter extends SearchParameter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CategorySearchParameter';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('Type', $data ?? [], 'CategorySearchParameter');
    }
