...
class RecommendationInfoBase extends RecommendationInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RecommendationInfoBase';
