...
class KeywordAndMatchType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'KeywordAndMatchType';
    ...
    */
    ...
    {
        if (!isset($this->container['KeywordText']) || is_null($this->container['KeywordText'])) {
            return null;
        }
     ...
     * Sets KeywordText
     *
     * @param string|null $KeywordText KeywordText
     *
     * @return self
     */
    public function setKeywordText($KeywordText)
    {
        if (is_null($KeywordText)) {
            array_push($this->openAPINullablesSetToNull, 'KeywordText');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('KeywordText', $nullablesSetToNull);
            if ($index !== FALSE) {
