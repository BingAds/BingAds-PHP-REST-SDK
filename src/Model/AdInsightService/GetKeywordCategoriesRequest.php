...
class GetKeywordCategoriesRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetKeywordCategoriesRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('MaxCategories', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (!isset($this->container['MaxCategories']) || is_null($this->container['MaxCategories'])) {
            return null;
        }
        return $this->container['MaxCategories'];
    }

    /**
     * Sets MaxCategories
     *
     * @param int|null $MaxCategories MaxCategories
     *
     * @return self
     */
    public function setMaxCategories($MaxCategories)
    {
        if (is_null($MaxCategories)) {
            array_push($this->openAPINullablesSetToNull, 'MaxCategories');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('MaxCategories', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['MaxCategories'] = $MaxCategories;
