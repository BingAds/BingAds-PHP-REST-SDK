...
class DomainCategory implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DomainCategory';
    ...
    */
    ...
    {
        if (!isset($this->container['CategoryName']) || is_null($this->container['CategoryName'])) {
            return null;
        }
    ...
    {
        if (!isset($this->container['Coverage']) || is_null($this->container['Coverage'])) {
            return null;
        }
     ...
     * Sets Coverage
     *
     * @param float|null $Coverage Coverage
     *
     * @return self
     */
