...
class SearchInsightPerformanceReportFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SearchInsightPerformanceReportFilter';
    ...
    {
        $this->setIfExists('SearchCategory', $data ?? [], null);
    ...
    */
    ...
    {
        if (!isset($this->container['SearchCategory']) || is_null($this->container['SearchCategory'])) {
            return null;
        }
        return $this->container['SearchCategory'];
    }

    /**
     * Sets SearchCategory
     *
     * @param string[]|null $SearchCategory SearchCategory
     *
     * @return self
     */
    public function setSearchCategory($SearchCategory)
    {
        if (is_null($SearchCategory)) {
            array_push($this->openAPINullablesSetToNull, 'SearchCategory');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('SearchCategory', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['SearchCategory'] = $SearchCategory;
