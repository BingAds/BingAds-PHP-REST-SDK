...
class ProfessionalDemographicsAudienceReportFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProfessionalDemographicsAudienceReportFilter';
