...
class ProductNegativeKeywordConflictReportFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductNegativeKeywordConflictReportFilter';
