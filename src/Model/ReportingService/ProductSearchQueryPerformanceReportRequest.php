...
class ProductSearchQueryPerformanceReportRequest extends ReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductSearchQueryPerformanceReportRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'Filter' => '\Microsoft\MsAds\Rest\Model\ReportingService\ProductSearchQueryPerformanceReportFilter',
        ...
        'Columns' => '\Microsoft\MsAds\Rest\Model\ReportingService\ProductSearchQueryPerformanceReportColumn[]',
        'Type' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('Type', $data ?? [], 'ProductSearchQueryPerformanceReportRequest');
    }
    ...
    */
     ...
     * Gets Filter
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\ProductSearchQueryPerformanceReportFilter|null
     */
     ...
     * Sets Filter
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\ProductSearchQueryPerformanceReportFilter|null $Filter Filter
     *
     * @return self
     */
     ...
     * Gets Columns
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\ProductSearchQueryPerformanceReportColumn[]|mixed|null
     */
     ...
     * Sets Columns
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\ProductSearchQueryPerformanceReportColumn[]|mixed|null $Columns Columns
     *
     * @return self
     */
    public function setColumns($Columns)
    {
        ...
        foreach ($Columns as $key => $ColumnsItem) {
            if (!$ColumnsItem instanceof \Microsoft\MsAds\Rest\Model\ReportingService\ProductSearchQueryPerformanceReportColumn) {
                $Columns[$key] = new \Microsoft\MsAds\Rest\Model\ReportingService\ProductSearchQueryPerformanceReportColumn($ColumnsItem);
            }
        }
