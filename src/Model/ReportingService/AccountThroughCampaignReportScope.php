...
class AccountThroughCampaignReportScope implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AccountThroughCampaignReportScope';
