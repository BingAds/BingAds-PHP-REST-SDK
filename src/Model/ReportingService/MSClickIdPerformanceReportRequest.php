...
class MSClickIdPerformanceReportRequest extends ReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MSClickIdPerformanceReportRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'Columns' => '\Microsoft\MsAds\Rest\Model\ReportingService\MSClickIdPerformanceReportColumn[]',
        'Type' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('Type', $data ?? [], 'MSClickIdPerformanceReportRequest');
    }
    ...
    */
     ...
     * Gets Columns
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\MSClickIdPerformanceReportColumn[]|mixed|null
     */
     ...
     * Sets Columns
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\MSClickIdPerformanceReportColumn[]|mixed|null $Columns Columns
     *
     * @return self
     */
    public function setColumns($Columns)
    {
        ...
        foreach ($Columns as $key => $ColumnsItem) {
            if (!$ColumnsItem instanceof \Microsoft\MsAds\Rest\Model\ReportingService\MSClickIdPerformanceReportColumn) {
                $Columns[$key] = new \Microsoft\MsAds\Rest\Model\ReportingService\MSClickIdPerformanceReportColumn($ColumnsItem);
            }
        }
