...
class ProductNegativeKeywordConflictReportRequest extends ReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductNegativeKeywordConflictReportRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'Columns' => '\Microsoft\MsAds\Rest\Model\ReportingService\ProductNegativeKeywordConflictReportColumn[]',
        'Filter' => '\Microsoft\MsAds\Rest\Model\ReportingService\ProductNegativeKeywordConflictReportFilter',
        'ReportName' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('Type', $data ?? [], 'ProductNegativeKeywordConflictReportRequest');
    }
    ...
    */
     ...
     * Gets Columns
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\ProductNegativeKeywordConflictReportColumn[]|mixed|null
     */
     ...
     * Sets Columns
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\ProductNegativeKeywordConflictReportColumn[]|mixed|null $Columns Columns
     *
     * @return self
     */
    public function setColumns($Columns)
    {
        ...
        foreach ($Columns as $key => $ColumnsItem) {
            if (!$ColumnsItem instanceof \Microsoft\MsAds\Rest\Model\ReportingService\ProductNegativeKeywordConflictReportColumn) {
                $Columns[$key] = new \Microsoft\MsAds\Rest\Model\ReportingService\ProductNegativeKeywordConflictReportColumn($ColumnsItem);
            }
        }
     ...
     * Gets Filter
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\ProductNegativeKeywordConflictReportFilter|null
     */
     ...
     * Sets Filter
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\ProductNegativeKeywordConflictReportFilter|null $Filter Filter
     *
     * @return self
     */
