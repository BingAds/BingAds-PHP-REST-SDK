...
class AdExtensionByKeywordReportFilter implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AdExtensionByKeywordReportFilter';
