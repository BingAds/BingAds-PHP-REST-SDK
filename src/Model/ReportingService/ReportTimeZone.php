...
class ReportTimeZone
{
    ...
    public const MAGADAN_SOLOMON_ISLAND_NEW_CALEDONIA = 'MagadanSolomonIslandNewCaledonia';
    ...
    public const ISLANDAMABAD_KARACHI_TASHKENT = 'IslandamabadKarachiTashkent';
    ...
    public const ATHENS_ISLANDANBUL_MINSK = 'AthensIslandanbulMinsk';
    ...
    public const MIDWAY_ISLANDAND_SAMOA = 'MidwayIslandandSamoa';
    ...
    public static function getAllowableEnumValues(): array
    {
        return [
            ...
            self::MAGADAN_SOLOMON_ISLAND_NEW_CALEDONIA,
            self::VLADIVOSTOK,
            self::HOBART,
            ...
            self::ISLANDAMABAD_KARACHI_TASHKENT,
            self::EKATERINBURG,
            self::KABUL,
