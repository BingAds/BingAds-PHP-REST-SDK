...
class GoalsAndFunnelsReportRequest extends ReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GoalsAndFunnelsReportRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'Filter' => '\Microsoft\MsAds\Rest\Model\ReportingService\GoalsAndFunnelsReportFilter',
        ...
        'Columns' => '\Microsoft\MsAds\Rest\Model\ReportingService\GoalsAndFunnelsReportColumn[]',
        'Type' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('Type', $data ?? [], 'GoalsAndFunnelsReportRequest');
    }
    ...
    */
     ...
     * Gets Filter
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\GoalsAndFunnelsReportFilter|null
     */
     ...
     * Sets Filter
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\GoalsAndFunnelsReportFilter|null $Filter Filter
     *
     * @return self
     */
     ...
     * Gets Columns
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\GoalsAndFunnelsReportColumn[]|mixed|null
     */
     ...
     * Sets Columns
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\GoalsAndFunnelsReportColumn[]|mixed|null $Columns Columns
     *
     * @return self
     */
    public function setColumns($Columns)
    {
        ...
        foreach ($Columns as $key => $ColumnsItem) {
            if (!$ColumnsItem instanceof \Microsoft\MsAds\Rest\Model\ReportingService\GoalsAndFunnelsReportColumn) {
                $Columns[$key] = new \Microsoft\MsAds\Rest\Model\ReportingService\GoalsAndFunnelsReportColumn($ColumnsItem);
            }
        }
