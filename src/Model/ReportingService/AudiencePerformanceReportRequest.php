...
class AudiencePerformanceReportRequest extends ReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AudiencePerformanceReportRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'Columns' => '\Microsoft\MsAds\Rest\Model\ReportingService\AudiencePerformanceReportColumn[]',
        'Filter' => '\Microsoft\MsAds\Rest\Model\ReportingService\AudiencePerformanceReportFilter',
        'Type' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('Type', $data ?? [], 'AudiencePerformanceReportRequest');
    }
    ...
    */
     ...
     * Gets Columns
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\AudiencePerformanceReportColumn[]|mixed|null
     */
     ...
     * Sets Columns
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\AudiencePerformanceReportColumn[]|mixed|null $Columns Columns
     *
     * @return self
     */
    public function setColumns($Columns)
    {
        ...
        foreach ($Columns as $key => $ColumnsItem) {
            if (!$ColumnsItem instanceof \Microsoft\MsAds\Rest\Model\ReportingService\AudiencePerformanceReportColumn) {
                $Columns[$key] = new \Microsoft\MsAds\Rest\Model\ReportingService\AudiencePerformanceReportColumn($ColumnsItem);
            }
        }
     ...
     * Gets Filter
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\AudiencePerformanceReportFilter|null
     */
     ...
     * Sets Filter
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\AudiencePerformanceReportFilter|null $Filter Filter
     *
     * @return self
     */
