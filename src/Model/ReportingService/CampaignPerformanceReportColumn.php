...
class CampaignPerformanceReportColumn
{
    ...
    public const BUDGET_NAME = 'BudgetName';

    public const BUDGET_STATUS = 'BudgetStatus';

    public const BUDGET_ASSOCIATION_STATUS = 'BudgetAssociationStatus';
    ...
    public static function getAllowableEnumValues(): array
    {
        return [
            ...
            self::BUDGET_NAME,
            self::BUDGET_STATUS,
            self::BUDGET_ASSOCIATION_STATUS,
