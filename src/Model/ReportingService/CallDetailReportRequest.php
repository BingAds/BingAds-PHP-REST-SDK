...
class CallDetailReportRequest extends ReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CallDetailReportRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'Columns' => '\Microsoft\MsAds\Rest\Model\ReportingService\CallDetailReportColumn[]',
        'Filter' => '\Microsoft\MsAds\Rest\Model\ReportingService\CallDetailReportFilter',
        'Type' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('Type', $data ?? [], 'CallDetailReportRequest');
    }
    ...
    */
     ...
     * Gets Columns
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\CallDetailReportColumn[]|mixed|null
     */
     ...
     * Sets Columns
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\CallDetailReportColumn[]|mixed|null $Columns Columns
     *
     * @return self
     */
    public function setColumns($Columns)
    {
        ...
        foreach ($Columns as $key => $ColumnsItem) {
            if (!$ColumnsItem instanceof \Microsoft\MsAds\Rest\Model\ReportingService\CallDetailReportColumn) {
                $Columns[$key] = new \Microsoft\MsAds\Rest\Model\ReportingService\CallDetailReportColumn($ColumnsItem);
            }
        }
     ...
     * Gets Filter
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\CallDetailReportFilter|null
     */
     ...
     * Sets Filter
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\CallDetailReportFilter|null $Filter Filter
     *
     * @return self
     */
