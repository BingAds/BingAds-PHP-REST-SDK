...
class AdExtensionByAdReportRequest extends ReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AdExtensionByAdReportRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'Columns' => '\Microsoft\MsAds\Rest\Model\ReportingService\AdExtensionByAdReportColumn[]',
        'Filter' => '\Microsoft\MsAds\Rest\Model\ReportingService\AdExtensionByAdReportFilter',
        'Type' => 'string'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('Type', $data ?? [], 'AdExtensionByAdReportRequest');
    }
    ...
    */
     ...
     * Gets Columns
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\AdExtensionByAdReportColumn[]|mixed|null
     */
     ...
     * Sets Columns
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\AdExtensionByAdReportColumn[]|mixed|null $Columns Columns
     *
     * @return self
     */
    public function setColumns($Columns)
    {
        ...
        foreach ($Columns as $key => $ColumnsItem) {
            if (!$ColumnsItem instanceof \Microsoft\MsAds\Rest\Model\ReportingService\AdExtensionByAdReportColumn) {
                $Columns[$key] = new \Microsoft\MsAds\Rest\Model\ReportingService\AdExtensionByAdReportColumn($ColumnsItem);
            }
        }
     ...
     * Gets Filter
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\AdExtensionByAdReportFilter|null
     */
     ...
     * Sets Filter
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\AdExtensionByAdReportFilter|null $Filter Filter
     *
     * @return self
     */
