<?php
/**
 * DSAAutoTargetPerformanceReportColumn
 * ReportingService
 *
 * PHP version 7.4
 *
...
class DSAAutoTargetPerformanceReportColumn
{
    ...
    public const DYNAMIC_AD_TARGET_STATUS = 'DynamicAdTargetStatus';

    public const WEBSITE_COVERAGE = 'WebsiteCoverage';
    ...
    public static function getAllowableEnumValues(): array
    {
        return [
            ...
            self::DYNAMIC_AD_TARGET_STATUS,
            self::WEBSITE_COVERAGE,
            self::IMPRESSIONS,
            self::CLICKS,
            self::CTR,
            self::AVERAGE_CPC,
