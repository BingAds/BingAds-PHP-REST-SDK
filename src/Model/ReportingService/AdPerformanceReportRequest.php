...
class AdPerformanceReportRequest extends ReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AdPerformanceReportRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'Filter' => '\Microsoft\MsAds\Rest\Model\ReportingService\AdPerformanceReportFilter',
        ...
        'Columns' => '\Microsoft\MsAds\Rest\Model\ReportingService\AdPerformanceReportColumn[]',
        'ReportName' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('Type', $data ?? [], 'AdPerformanceReportRequest');
    }
    ...
    */
     ...
     * Gets Filter
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\AdPerformanceReportFilter|null
     */
     ...
     * Sets Filter
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\AdPerformanceReportFilter|null $Filter Filter
     *
     * @return self
     */
     ...
     * Gets Columns
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\AdPerformanceReportColumn[]|mixed|null
     */
     ...
     * Sets Columns
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\AdPerformanceReportColumn[]|mixed|null $Columns Columns
     *
     * @return self
     */
    public function setColumns($Columns)
    {
        ...
        foreach ($Columns as $key => $ColumnsItem) {
            if (!$ColumnsItem instanceof \Microsoft\MsAds\Rest\Model\ReportingService\AdPerformanceReportColumn) {
                $Columns[$key] = new \Microsoft\MsAds\Rest\Model\ReportingService\AdPerformanceReportColumn($ColumnsItem);
            }
        }
