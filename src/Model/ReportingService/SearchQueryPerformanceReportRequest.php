...
class SearchQueryPerformanceReportRequest extends ReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SearchQueryPerformanceReportRequest';
    ...
    protected static array $openAPITypes = [
        ...
        'Filter' => '\Microsoft\MsAds\Rest\Model\ReportingService\SearchQueryPerformanceReportFilter',
        ...
        'Columns' => '\Microsoft\MsAds\Rest\Model\ReportingService\SearchQueryPerformanceReportColumn[]',
        'ReportName' => 'string',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('Type', $data ?? [], 'SearchQueryPerformanceReportRequest');
    }
    ...
    */
     ...
     * Gets Filter
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\SearchQueryPerformanceReportFilter|null
     */
     ...
     * Sets Filter
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\SearchQueryPerformanceReportFilter|null $Filter Filter
     *
     * @return self
     */
     ...
     * Gets Columns
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\SearchQueryPerformanceReportColumn[]|mixed|null
     */
     ...
     * Sets Columns
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\SearchQueryPerformanceReportColumn[]|mixed|null $Columns Columns
     *
     * @return self
     */
    public function setColumns($Columns)
    {
        ...
        foreach ($Columns as $key => $ColumnsItem) {
            if (!$ColumnsItem instanceof \Microsoft\MsAds\Rest\Model\ReportingService\SearchQueryPerformanceReportColumn) {
                $Columns[$key] = new \Microsoft\MsAds\Rest\Model\ReportingService\SearchQueryPerformanceReportColumn($ColumnsItem);
            }
        }
