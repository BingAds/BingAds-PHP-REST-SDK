...
class KeywordPerformanceReportRequest extends ReportRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'KeywordPerformanceReportRequest';
    ...
    */
     ...
     * Gets Filter
     *
     * @return \Microsoft\MsAds\Rest\Model\ReportingService\KeywordPerformanceReportFilter|null
     */
     ...
     * Sets Filter
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\KeywordPerformanceReportFilter|null $Filter Filter
     *
     * @return self
     */
     ...
     * Sets Columns
     *
     * @param \Microsoft\MsAds\Rest\Model\ReportingService\KeywordPerformanceReportColumn[]|mixed|null $Columns Columns
     *
     * @return self
     */
    public function setColumns($Columns)
    {
        ...
        foreach ($Columns as $key => $ColumnsItem) {
            if (!$ColumnsItem instanceof \Microsoft\MsAds\Rest\Model\ReportingService\KeywordPerformanceReportColumn) {
                $Columns[$key] = new \Microsoft\MsAds\Rest\Model\ReportingService\KeywordPerformanceReportColumn($ColumnsItem);
            }
        }
