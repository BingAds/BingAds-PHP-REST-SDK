...
class GetBulkUploadUrlResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetBulkUploadUrlResponse';
    ...
    */
    ...
    {
        if (!isset($this->container['UploadUrl']) || is_null($this->container['UploadUrl'])) {
            return null;
        }
