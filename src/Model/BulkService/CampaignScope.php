...
class CampaignScope implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CampaignScope';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ParentAccountId', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (!isset($this->container['ParentAccountId']) || is_null($this->container['ParentAccountId'])) {
            return null;
        }
     ...
     *
     * @param string|null $ParentAccountId ParentAccountId
     *
     * @return self
     */
    public function setParentAccountId($ParentAccountId)
    {
        if (is_null($ParentAccountId)) {
            throw new \InvalidArgumentException('non-nullable ParentAccountId cannot be null');
        }
