...
class BrandKitFont implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BrandKitFont';
    ...
    protected static array $setters = [
        ...
        'Weight' => 'setWeight',
        'TextAssetType' => 'setTextAssetType'
    ];
    ...
    protected static array $getters = [
        ...
        'Weight' => 'getWeight',
        'TextAssetType' => 'getTextAssetType'
    ];
    ...
    {
        $this->setIfExists('Typeface', $data ?? [], null);
        $this->setIfExists('Weight', $data ?? [], null);
        $this->setIfExists('TextAssetType', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (!isset($this->container['Typeface']) || is_null($this->container['Typeface'])) {
            return null;
        }
    ...
    {
        if (is_null($Typeface)) {
            array_push($this->openAPINullablesSetToNull, 'Typeface');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('Typeface', $nullablesSetToNull);
            if ($index !== FALSE) {
    ...
    {
        if (!isset($this->container['Weight']) || is_null($this->container['Weight'])) {
            return null;
        }
