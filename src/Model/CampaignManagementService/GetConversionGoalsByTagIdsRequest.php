...
class GetConversionGoalsByTagIdsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetConversionGoalsByTagIdsRequest';
    ...
    */
    ...
    {
        if (!isset($this->container['ConversionGoalTypes']) || is_null($this->container['ConversionGoalTypes'])) {
            return null;
        }
        if ((is_object($this->container['ConversionGoalTypes']) || is_string($this->container['ConversionGoalTypes'])) && method_exists($this->container['ConversionGoalTypes'], 'getValue')) {
            return $this->container['ConversionGoalTypes']->getValue();
        }
        return $this->container['ConversionGoalTypes'];
    }

    /**
     * Sets ConversionGoalTypes
     *
     * @param \Microsoft\MsAds\Rest\Model\CampaignManagementService\ConversionGoalType|mixed|null $ConversionGoalTypes ConversionGoalTypes
     *
     * @return self
     */
    public function setConversionGoalTypes($ConversionGoalTypes)
    {
        if (is_null($ConversionGoalTypes)) {
            throw new \InvalidArgumentException('non-nullable ConversionGoalTypes cannot be null');
        }
        if (!$ConversionGoalTypes instanceof \Microsoft\MsAds\Rest\Model\CampaignManagementService\ConversionGoalType) {
            $ConversionGoalTypes = new \Microsoft\MsAds\Rest\Model\CampaignManagementService\ConversionGoalType($ConversionGoalTypes);
        }
        $this->container['ConversionGoalTypes'] = $ConversionGoalTypes;
     ...
     *
     * @return \Microsoft\MsAds\Rest\Model\CampaignManagementService\ConversionGoalAdditionalField|mixed|null
     */
     ...
     *
     * @param \Microsoft\MsAds\Rest\Model\CampaignManagementService\ConversionGoalAdditionalField|mixed|null $ReturnAdditionalFields ReturnAdditionalFields
     *
     * @return self
     */
    public function setReturnAdditionalFields($ReturnAdditionalFields)
    {
        ...
        if (!$ReturnAdditionalFields instanceof \Microsoft\MsAds\Rest\Model\CampaignManagementService\ConversionGoalAdditionalField) {
