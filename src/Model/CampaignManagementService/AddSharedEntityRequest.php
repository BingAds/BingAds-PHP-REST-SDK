...
class AddSharedEntityRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AddSharedEntityRequest';
    ...
    protected static array $openAPITypes = [
        'SharedEntity' => '\Microsoft\MsAds\Rest\Model\CampaignManagementService\SharedEntity',
    ...
    {
        $this->setIfExists('SharedEntity', $data ?? [], null);
    ...
    */
     ...
     * Gets SharedEntity
     *
     * @return \Microsoft\MsAds\Rest\Model\CampaignManagementService\SharedEntity|null
     */
    public function getSharedEntity()
    {
        if (!isset($this->container['SharedEntity']) || is_null($this->container['SharedEntity'])) {
            return null;
        }
     ...
     * Sets SharedEntity
     *
     * @param \Microsoft\MsAds\Rest\Model\CampaignManagementService\SharedEntity|null $SharedEntity SharedEntity
     *
     * @return self
     */
    public function setSharedEntity($SharedEntity)
    {
        if (is_null($SharedEntity)) {
            array_push($this->openAPINullablesSetToNull, 'SharedEntity');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('SharedEntity', $nullablesSetToNull);
            if ($index !== FALSE) {
