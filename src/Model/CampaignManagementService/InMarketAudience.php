...
class InMarketAudience extends Audience implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'InMarketAudience';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('Type', $data ?? [], 'InMarket');
