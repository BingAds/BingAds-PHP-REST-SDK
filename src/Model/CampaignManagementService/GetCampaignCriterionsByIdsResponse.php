...
class GetCampaignCriterionsByIdsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetCampaignCriterionsByIdsResponse';
    ...
    */
    ...
    {
        if (!isset($this->container['CampaignCriterions']) || is_null($this->container['CampaignCriterions'])) {
            return null;
        }
        return $this->container['CampaignCriterions'];
    }

    /**
     * Sets CampaignCriterions
     *
     * @param \Microsoft\MsAds\Rest\Model\CampaignManagementService\CampaignCriterion[]|null $CampaignCriterions CampaignCriterions
     *
     * @return self
     */
    public function setCampaignCriterions($CampaignCriterions)
    {
        if (is_null($CampaignCriterions)) {
            array_push($this->openAPINullablesSetToNull, 'CampaignCriterions');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('CampaignCriterions', $nullablesSetToNull);
            if ($index !== FALSE) {
