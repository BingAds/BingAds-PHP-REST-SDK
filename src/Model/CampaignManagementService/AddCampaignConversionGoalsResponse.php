...
class AddCampaignConversionGoalsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AddCampaignConversionGoalsResponse';
