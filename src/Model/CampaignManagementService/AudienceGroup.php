...
class AudienceGroup implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AudienceGroup';
    ...
    */
     ...
     * Gets Dimensions
     *
     * @return \Microsoft\MsAds\Rest\Model\CampaignManagementService\AudienceGroupDimension[]|null
     */
    public function getDimensions()
    {
        if (!isset($this->container['Dimensions']) || is_null($this->container['Dimensions'])) {
            return null;
        }
     ...
     * Sets Dimensions
     *
     * @param \Microsoft\MsAds\Rest\Model\CampaignManagementService\AudienceGroupDimension[]|null $Dimensions Dimensions
     *
     * @return self
     */
