...
class GetUetTagsByIdsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetUetTagsByIdsResponse';
    ...
    protected static array $openAPITypes = [
        'UetTags' => '\Microsoft\MsAds\Rest\Model\CampaignManagementService\UetTag[]',
    ...
    {
        $this->setIfExists('UetTags', $data ?? [], null);
    ...
    */
     ...
     * Gets UetTags
     *
     * @return \Microsoft\MsAds\Rest\Model\CampaignManagementService\UetTag[]|null
     */
    public function getUetTags()
    {
        if (!isset($this->container['UetTags']) || is_null($this->container['UetTags'])) {
            return null;
        }
        return $this->container['UetTags'];
    }

    /**
     * Sets UetTags
     *
     * @param \Microsoft\MsAds\Rest\Model\CampaignManagementService\UetTag[]|null $UetTags UetTags
     *
     * @return self
     */
    ...
    {
        if (is_null($UetTags)) {
            array_push($this->openAPINullablesSetToNull, 'UetTags');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('UetTags', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['UetTags'] = $UetTags;
