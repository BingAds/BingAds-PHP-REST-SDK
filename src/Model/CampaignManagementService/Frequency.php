...
class Frequency implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'Frequency';
    ...
    */
    ...
    {
        if (!isset($this->container['Cron']) || is_null($this->container['Cron'])) {
            return null;
        }
