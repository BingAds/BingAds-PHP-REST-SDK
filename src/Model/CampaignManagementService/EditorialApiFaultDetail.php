...
class EditorialApiFaultDetail extends ApplicationFault implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'EditorialApiFaultDetail';
