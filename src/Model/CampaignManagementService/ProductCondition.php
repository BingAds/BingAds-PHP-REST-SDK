...
class ProductCondition implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ProductCondition';
    ...
    */
    ...
    {
        if (!isset($this->container['Attribute']) || is_null($this->container['Attribute'])) {
            return null;
        }
