...
class AdCenterInternalErrorFault extends ApplicationFault implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AdCenterInternalErrorFault';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('Type', $data ?? [], 'AdCenterInternalErrorFault');
    }
