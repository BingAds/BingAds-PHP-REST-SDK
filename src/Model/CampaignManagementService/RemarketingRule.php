...
class RemarketingRule implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const MAPPINGS = [
        'CustomEvents' => 'Microsoft\MsAds\Rest\Model\CampaignManagementService\CustomEventsRule',
        'PageVisitors' => 'Microsoft\MsAds\Rest\Model\CampaignManagementService\PageVisitorsRule',
        'PageVisitorsWhoDidNotVisitAnotherPage' => 'Microsoft\MsAds\Rest\Model\CampaignManagementService\PageVisitorsWhoDidNotVisitAnotherPageRule',
        'PageVisitorsWhoVisitedAnotherPage' => 'Microsoft\MsAds\Rest\Model\CampaignManagementService\PageVisitorsWhoVisitedAnotherPageRule',
    ];
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RemarketingRule';
    ...
    protected static array $openAPITypes = [
        'Type' => 'string',
        'RuleItemGroups' => '\Microsoft\MsAds\Rest\Model\CampaignManagementService\RuleItemGroup[]',
        'NormalForm' => '\Microsoft\MsAds\Rest\Model\CampaignManagementService\NormalForm',
        'AnotherRuleItemGroups' => '\Microsoft\MsAds\Rest\Model\CampaignManagementService\RuleItemGroup[]',
    ...
    protected static array $attributeMap = [
        'Type' => 'Type',
        'RuleItemGroups' => 'RuleItemGroups',
        'NormalForm' => 'NormalForm',
        'AnotherRuleItemGroups' => 'AnotherRuleItemGroups',
    ...
    protected static array $setters = [
        'Type' => 'setType',
        'RuleItemGroups' => 'setRuleItemGroups',
        'NormalForm' => 'setNormalForm',
        'AnotherRuleItemGroups' => 'setAnotherRuleItemGroups',
    ...
    protected static array $getters = [
        'Type' => 'getType',
        'RuleItemGroups' => 'getRuleItemGroups',
        'NormalForm' => 'getNormalForm',
        'AnotherRuleItemGroups' => 'getAnotherRuleItemGroups',
    ...
    */
    ...
    {
        if (!isset($this->container['RuleItemGroups']) || is_null($this->container['RuleItemGroups'])) {
            return null;
        }
        return $this->container['RuleItemGroups'];
    }

    /**
     * Sets RuleItemGroups
     *
     * @param \Microsoft\MsAds\Rest\Model\CampaignManagementService\RuleItemGroup[]|null $RuleItemGroups RuleItemGroups
     *
     * @return self
     */
    public function setRuleItemGroups($RuleItemGroups)
    {
        if (is_null($RuleItemGroups)) {
            array_push($this->openAPINullablesSetToNull, 'RuleItemGroups');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('RuleItemGroups', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['RuleItemGroups'] = $RuleItemGroups;
     ...
     * Gets NormalForm
     *
     * @return \Microsoft\MsAds\Rest\Model\CampaignManagementService\NormalForm|mixed|null
     */
    public function getNormalForm()
    {
        if (!isset($this->container['NormalForm']) || is_null($this->container['NormalForm'])) {
            return null;
        }
        if ((is_object($this->container['NormalForm']) || is_string($this->container['NormalForm'])) && method_exists($this->container['NormalForm'], 'getValue')) {
            return $this->container['NormalForm']->getValue();
        }
        return $this->container['NormalForm'];
    }

    /**
     * Sets NormalForm
     *
     * @param \Microsoft\MsAds\Rest\Model\CampaignManagementService\NormalForm|mixed|null $NormalForm NormalForm
     *
     * @return self
     */
    public function setNormalForm($NormalForm)
    {
        if (is_null($NormalForm)) {
            throw new \InvalidArgumentException('non-nullable NormalForm cannot be null');
        }
        if (!$NormalForm instanceof \Microsoft\MsAds\Rest\Model\CampaignManagementService\NormalForm) {
            $NormalForm = new \Microsoft\MsAds\Rest\Model\CampaignManagementService\NormalForm($NormalForm);
        }
        $this->container['NormalForm'] = $NormalForm;

        return $this;
    }

    /**
     * Gets AnotherRuleItemGroups
     *
     * @return \Microsoft\MsAds\Rest\Model\CampaignManagementService\RuleItemGroup[]|null
     */
    public function getAnotherRuleItemGroups()
    {
        if (!isset($this->container['AnotherRuleItemGroups']) || is_null($this->container['AnotherRuleItemGroups'])) {
            return null;
        }
        return $this->container['AnotherRuleItemGroups'];
    }

    /**
     * Sets AnotherRuleItemGroups
     *
     * @param \Microsoft\MsAds\Rest\Model\CampaignManagementService\RuleItemGroup[]|null $AnotherRuleItemGroups AnotherRuleItemGroups
     *
     * @return self
     */
    public function setAnotherRuleItemGroups($AnotherRuleItemGroups)
    {
        if (is_null($AnotherRuleItemGroups)) {
            array_push($this->openAPINullablesSetToNull, 'AnotherRuleItemGroups');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('AnotherRuleItemGroups', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['AnotherRuleItemGroups'] = $AnotherRuleItemGroups;
