...
class ImpressionBasedRemarketingList extends Audience implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ImpressionBasedRemarketingList';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('Type', $data ?? [], 'ImpressionBasedRemarketingList');
