...
class AssetGroupSearchTheme implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AssetGroupSearchTheme';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('SearchTheme', $data ?? [], null);
    ...
    */
    ...
    {
        if (!isset($this->container['SearchTheme']) || is_null($this->container['SearchTheme'])) {
            return null;
        }
        return $this->container['SearchTheme'];
    }

    /**
     * Sets SearchTheme
     *
     * @param string|null $SearchTheme SearchTheme
     *
     * @return self
     */
    public function setSearchTheme($SearchTheme)
    {
        if (is_null($SearchTheme)) {
            array_push($this->openAPINullablesSetToNull, 'SearchTheme');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('SearchTheme', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['SearchTheme'] = $SearchTheme;
