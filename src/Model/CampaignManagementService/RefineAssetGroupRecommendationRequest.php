...
class RefineAssetGroupRecommendationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RefineAssetGroupRecommendationRequest';
