...
class GetMediaMetaDataByIdsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetMediaMetaDataByIdsRequest';
    ...
    {
        $this->setIfExists('MediaIds', $data ?? [], null);
    ...
    */
    ...
    {
        if (!isset($this->container['MediaIds']) || is_null($this->container['MediaIds'])) {
            return null;
        }
    ...
    {
        if (is_null($MediaIds)) {
            array_push($this->openAPINullablesSetToNull, 'MediaIds');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('MediaIds', $nullablesSetToNull);
            if ($index !== FALSE) {
