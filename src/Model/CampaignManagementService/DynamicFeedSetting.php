...
class DynamicFeedSetting extends Setting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DynamicFeedSetting';
