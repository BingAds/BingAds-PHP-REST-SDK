...
class HotelAdvanceBookingWindowCriterion extends Criterion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'HotelAdvanceBookingWindowCriterion';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('Type', $data ?? [], 'HotelAdvanceBookingWindowCriterion');
    }
