...
class DeleteListItemsFromSharedListRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DeleteListItemsFromSharedListRequest';
    ...
    {
        $this->setIfExists('ListItemIds', $data ?? [], null);
    ...
    */
    ...
    {
        if (!isset($this->container['ListItemIds']) || is_null($this->container['ListItemIds'])) {
            return null;
        }
        return $this->container['ListItemIds'];
    }

    /**
     * Sets ListItemIds
     *
     * @param string[]|null $ListItemIds ListItemIds
     *
     * @return self
     */
    public function setListItemIds($ListItemIds)
    {
        if (is_null($ListItemIds)) {
            array_push($this->openAPINullablesSetToNull, 'ListItemIds');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ListItemIds', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['ListItemIds'] = $ListItemIds;
