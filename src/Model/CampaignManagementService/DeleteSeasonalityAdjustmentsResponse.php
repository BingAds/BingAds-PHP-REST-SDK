...
class DeleteSeasonalityAdjustmentsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DeleteSeasonalityAdjustmentsResponse';
