...
class RecommendationBusinessName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'RecommendationBusinessName';
    ...
    */
    ...
    {
        if (!isset($this->container['Display']) || is_null($this->container['Display'])) {
            return null;
        }
