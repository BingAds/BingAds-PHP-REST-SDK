...
class ApplyOfflineConversionAdjustmentsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ApplyOfflineConversionAdjustmentsResponse';
