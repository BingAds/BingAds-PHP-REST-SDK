...
class GetLabelAssociationsByLabelIdsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetLabelAssociationsByLabelIdsRequest';
    ...
    */
    ...
    {
        if (!isset($this->container['LabelIds']) || is_null($this->container['LabelIds'])) {
            return null;
        }
     ...
     * Sets LabelIds
     *
     * @param string[]|null $LabelIds LabelIds
     *
     * @return self
     */
    ...
    {
        if (is_null($LabelIds)) {
            array_push($this->openAPINullablesSetToNull, 'LabelIds');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('LabelIds', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
