...
class SetSharedEntityAssociationsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SetSharedEntityAssociationsRequest';
