...
class MigrationStatusInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MigrationStatusInfo';
    ...
    protected static array $openAPITypes = [
        ...
        'Status' => '\Microsoft\MsAds\Rest\Model\CampaignManagementService\MigrationStatus'
    ];
    ...
    */
    ...
    {
        if (!isset($this->container['MigrationType']) || is_null($this->container['MigrationType'])) {
            return null;
        }
     ...
     * Sets MigrationType
     *
     * @param string|null $MigrationType MigrationType
     *
     * @return self
     */
    ...
    public function setStartTimeInUtc($StartTimeInUtc)
    {
        if (is_null($StartTimeInUtc)) {
            array_push($this->openAPINullablesSetToNull, 'StartTimeInUtc');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('StartTimeInUtc', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
     ...
     * Gets Status
     *
     * @return \Microsoft\MsAds\Rest\Model\CampaignManagementService\MigrationStatus|mixed|null
     */
     ...
     * Sets Status
     *
     * @param \Microsoft\MsAds\Rest\Model\CampaignManagementService\MigrationStatus|mixed|null $Status Status
     *
     * @return self
     */
    public function setStatus($Status)
    {
        ...
        if (!$Status instanceof \Microsoft\MsAds\Rest\Model\CampaignManagementService\MigrationStatus) {
            $Status = new \Microsoft\MsAds\Rest\Model\CampaignManagementService\MigrationStatus($Status);
        }
