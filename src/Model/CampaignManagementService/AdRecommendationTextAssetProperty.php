...
class AdRecommendationTextAssetProperty implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AdRecommendationTextAssetProperty';
