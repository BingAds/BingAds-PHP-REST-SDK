...
class ManualCpaBiddingScheme extends BiddingScheme implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ManualCpaBiddingScheme';
    ...
    {
        $this->setIfExists('Type', $data ?? [], 'ManualCpaBiddingScheme');
