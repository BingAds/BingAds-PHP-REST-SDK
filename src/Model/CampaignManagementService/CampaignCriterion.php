...
class CampaignCriterion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const MAPPINGS = [
        'BiddableCampaignCriterion' => 'Microsoft\MsAds\Rest\Model\CampaignManagementService\BiddableCampaignCriterion',
        'NegativeCampaignCriterion' => 'Microsoft\MsAds\Rest\Model\CampaignManagementService\NegativeCampaignCriterion',
    ];
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CampaignCriterion';
