...
class GetAdExtensionsByIdsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetAdExtensionsByIdsResponse';
    ...
    protected static array $openAPITypes = [
        'AdExtensions' => '\Microsoft\MsAds\Rest\Model\CampaignManagementService\AdExtension[]',
    ...
    {
        $this->setIfExists('AdExtensions', $data ?? [], null);
    ...
    */
    ...
    {
        if (!isset($this->container['AdExtensions']) || is_null($this->container['AdExtensions'])) {
            return null;
        }
        return $this->container['AdExtensions'];
    }

    /**
     * Sets AdExtensions
     *
     * @param \Microsoft\MsAds\Rest\Model\CampaignManagementService\AdExtension[]|null $AdExtensions AdExtensions
     *
     * @return self
     */
    public function setAdExtensions($AdExtensions)
    {
        if (is_null($AdExtensions)) {
            array_push($this->openAPINullablesSetToNull, 'AdExtensions');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('AdExtensions', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['AdExtensions'] = $AdExtensions;
