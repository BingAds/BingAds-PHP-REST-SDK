...
class CustomerAccountShareAssociation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomerAccountShareAssociation';
    ...
    */
    ...
    {
        if (!isset($this->container['UsageType']) || is_null($this->container['UsageType'])) {
            return null;
        }
     ...
     * Sets UsageType
     *
     * @param string|null $UsageType UsageType
     *
     * @return self
     */
    public function setUsageType($UsageType)
    {
        if (is_null($UsageType)) {
            array_push($this->openAPINullablesSetToNull, 'UsageType');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('UsageType', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     *
     * @param string|null $AssociationCount AssociationCount
     *
     * @return self
     */
