...
class AdExtensionEditorialReason implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AdExtensionEditorialReason';
    ...
    */
     ...
     * Sets ReasonCode
     *
     * @param int|null $ReasonCode ReasonCode
     *
     * @return self
     */
    ...
    {
        if (!isset($this->container['Term']) || is_null($this->container['Term'])) {
            return null;
        }
