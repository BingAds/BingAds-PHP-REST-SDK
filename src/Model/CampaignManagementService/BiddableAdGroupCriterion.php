...
class BiddableAdGroupCriterion extends AdGroupCriterion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BiddableAdGroupCriterion';
