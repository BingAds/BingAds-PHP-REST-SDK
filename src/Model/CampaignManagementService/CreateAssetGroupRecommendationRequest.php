...
class CreateAssetGroupRecommendationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CreateAssetGroupRecommendationRequest';
