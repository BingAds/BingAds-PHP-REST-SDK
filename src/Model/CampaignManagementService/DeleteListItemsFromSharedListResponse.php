...
class DeleteListItemsFromSharedListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DeleteListItemsFromSharedListResponse';
