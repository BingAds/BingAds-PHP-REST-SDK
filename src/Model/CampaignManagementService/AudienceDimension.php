...
class AudienceDimension extends AudienceGroupDimension implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AudienceDimension';
