...
class CallToAction
{
    ...
    public const NO_BUTTON = 'NoButton';

    public const INSTALL = 'Install';

    public const ADD_TO_CART = 'AddToCart';

    public const BOOK_TRAVEL = 'BookTravel';

    public const BUY = 'Buy';

    public const OPEN_LINK = 'OpenLink';

    public const REGISTER_NOW = 'RegisterNow';
    ...
    public const VIEW_QUOTE = 'ViewQuote';

    public const JOIN = 'Join';

    public const ATTEND = 'Attend';

    public const REQUEST_DEMO = 'RequestDemo';
