...
class GetVideosByIdsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetVideosByIdsRequest';
    ...
    {
        $this->setIfExists('VideoIds', $data ?? [], null);
    ...
    */
    ...
    {
        if (!isset($this->container['VideoIds']) || is_null($this->container['VideoIds'])) {
            return null;
        }
     ...
     * Sets VideoIds
     *
     * @param string[]|null $VideoIds VideoIds
     *
     * @return self
     */
    ...
    {
        if (is_null($VideoIds)) {
            array_push($this->openAPINullablesSetToNull, 'VideoIds');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('VideoIds', $nullablesSetToNull);
            if ($index !== FALSE) {
