...
class GetAssetGroupsByCampaignIdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetAssetGroupsByCampaignIdRequest';
