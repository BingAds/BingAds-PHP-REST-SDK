...
class GetBidStrategiesByIdsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetBidStrategiesByIdsResponse';
    ...
    protected static array $openAPITypes = [
        'BidStrategies' => '\Microsoft\MsAds\Rest\Model\CampaignManagementService\BidStrategy[]',
    ...
    protected static array $setters = [
        'BidStrategies' => 'setBidStrategies',
    ...
    {
        $this->setIfExists('BidStrategies', $data ?? [], null);
    ...
    */
     ...
     * Gets BidStrategies
     *
     * @return \Microsoft\MsAds\Rest\Model\CampaignManagementService\BidStrategy[]|null
     */
    public function getBidStrategies()
    {
        if (!isset($this->container['BidStrategies']) || is_null($this->container['BidStrategies'])) {
            return null;
        }
        return $this->container['BidStrategies'];
    }

    /**
     * Sets BidStrategies
     *
     * @param \Microsoft\MsAds\Rest\Model\CampaignManagementService\BidStrategy[]|null $BidStrategies BidStrategies
     *
     * @return self
     */
    public function setBidStrategies($BidStrategies)
    {
        if (is_null($BidStrategies)) {
            array_push($this->openAPINullablesSetToNull, 'BidStrategies');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('BidStrategies', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['BidStrategies'] = $BidStrategies;
