...
class SetSharedEntityAssociationsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SetSharedEntityAssociationsResponse';
