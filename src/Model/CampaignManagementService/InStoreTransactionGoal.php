...
class InStoreTransactionGoal extends ConversionGoal implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'InStoreTransactionGoal';
