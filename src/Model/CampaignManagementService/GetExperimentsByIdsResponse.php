...
class GetExperimentsByIdsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetExperimentsByIdsResponse';
    ...
    protected static array $openAPITypes = [
        'Experiments' => '\Microsoft\MsAds\Rest\Model\CampaignManagementService\Experiment[]',
    ...
    */
     ...
     * Gets Experiments
     *
     * @return \Microsoft\MsAds\Rest\Model\CampaignManagementService\Experiment[]|null
     */
    public function getExperiments()
    {
        if (!isset($this->container['Experiments']) || is_null($this->container['Experiments'])) {
            return null;
        }
     ...
     * Sets Experiments
     *
     * @param \Microsoft\MsAds\Rest\Model\CampaignManagementService\Experiment[]|null $Experiments Experiments
     *
     * @return self
     */
    public function setExperiments($Experiments)
    {
        if (is_null($Experiments)) {
            array_push($this->openAPINullablesSetToNull, 'Experiments');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('Experiments', $nullablesSetToNull);
            if ($index !== FALSE) {
