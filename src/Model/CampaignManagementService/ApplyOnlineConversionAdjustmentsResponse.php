...
class ApplyOnlineConversionAdjustmentsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ApplyOnlineConversionAdjustmentsResponse';
