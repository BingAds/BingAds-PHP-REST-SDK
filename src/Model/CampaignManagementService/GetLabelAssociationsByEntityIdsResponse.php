...
class GetLabelAssociationsByEntityIdsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetLabelAssociationsByEntityIdsResponse';
    ...
    */
    ...
    {
        if (!isset($this->container['LabelAssociations']) || is_null($this->container['LabelAssociations'])) {
            return null;
        }
        return $this->container['LabelAssociations'];
    }

    /**
     * Sets LabelAssociations
     *
     * @param \Microsoft\MsAds\Rest\Model\CampaignManagementService\LabelAssociation[]|null $LabelAssociations LabelAssociations
     *
     * @return self
     */
    public function setLabelAssociations($LabelAssociations)
    {
        if (is_null($LabelAssociations)) {
            array_push($this->openAPINullablesSetToNull, 'LabelAssociations');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('LabelAssociations', $nullablesSetToNull);
            if ($index !== FALSE) {
