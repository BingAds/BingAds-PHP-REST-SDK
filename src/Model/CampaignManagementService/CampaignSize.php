...
class CampaignSize implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CampaignSize';
    ...
    */
    ...
    {
        if (!isset($this->container['Size']) || is_null($this->container['Size'])) {
            return null;
        }
