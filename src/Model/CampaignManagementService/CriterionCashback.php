...
class CriterionCashback implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const MAPPINGS = [
        'CashbackAdjustment' => 'Microsoft\MsAds\Rest\Model\CampaignManagementService\CashbackAdjustment',
    ];
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CriterionCashback';
