...
class GetImportJobsByIdsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetImportJobsByIdsResponse';
    ...
    protected static array $openAPITypes = [
        'ImportJobs' => '\Microsoft\MsAds\Rest\Model\CampaignManagementService\ImportJob[]',
    ...
    {
        $this->setIfExists('ImportJobs', $data ?? [], null);
    ...
    */
    ...
    {
        if (!isset($this->container['ImportJobs']) || is_null($this->container['ImportJobs'])) {
            return null;
        }
        return $this->container['ImportJobs'];
    }

    /**
     * Sets ImportJobs
     *
     * @param \Microsoft\MsAds\Rest\Model\CampaignManagementService\ImportJob[]|null $ImportJobs ImportJobs
     *
     * @return self
     */
    public function setImportJobs($ImportJobs)
    {
        if (is_null($ImportJobs)) {
            array_push($this->openAPINullablesSetToNull, 'ImportJobs');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ImportJobs', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['ImportJobs'] = $ImportJobs;
