...
class CreateAssetGroupRecommendationResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CreateAssetGroupRecommendationResponse';
    ...
    protected static array $openAPITypes = [
        'AssetGroup' => '\Microsoft\MsAds\Rest\Model\CampaignManagementService\AssetGroup',
    ...
    {
        $this->setIfExists('AssetGroup', $data ?? [], null);
    ...
    */
    ...
    {
        if (!isset($this->container['AssetGroup']) || is_null($this->container['AssetGroup'])) {
            return null;
        }
        return $this->container['AssetGroup'];
    }

    /**
     * Sets AssetGroup
     *
     * @param \Microsoft\MsAds\Rest\Model\CampaignManagementService\AssetGroup|null $AssetGroup AssetGroup
     *
     * @return self
     */
    public function setAssetGroup($AssetGroup)
    {
        if (is_null($AssetGroup)) {
            array_push($this->openAPINullablesSetToNull, 'AssetGroup');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('AssetGroup', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['AssetGroup'] = $AssetGroup;
