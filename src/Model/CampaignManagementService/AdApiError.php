...
class AdApiError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AdApiError';
    ...
    */
    ...
    {
        if (!isset($this->container['Detail']) || is_null($this->container['Detail'])) {
            return null;
        }
