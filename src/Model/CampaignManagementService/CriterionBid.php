...
class CriterionBid implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const MAPPINGS = [
        'BidMultiplier' => 'Microsoft\MsAds\Rest\Model\CampaignManagementService\BidMultiplier',
        'FixedBid' => 'Microsoft\MsAds\Rest\Model\CampaignManagementService\FixedBid',
        'RateBid' => 'Microsoft\MsAds\Rest\Model\CampaignManagementService\RateBid',
    ];
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CriterionBid';
