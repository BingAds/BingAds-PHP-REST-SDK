...
class GetExperimentsByIdsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetExperimentsByIdsRequest';
    ...
    */
    ...
    {
        if (!isset($this->container['ExperimentIds']) || is_null($this->container['ExperimentIds'])) {
            return null;
        }
     ...
     * Sets ExperimentIds
     *
     * @param string[]|null $ExperimentIds ExperimentIds
     *
     * @return self
     */
    public function setExperimentIds($ExperimentIds)
    {
        if (is_null($ExperimentIds)) {
            array_push($this->openAPINullablesSetToNull, 'ExperimentIds');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ExperimentIds', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
