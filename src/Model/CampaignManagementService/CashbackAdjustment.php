...
class CashbackAdjustment extends CriterionCashback implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CashbackAdjustment';
