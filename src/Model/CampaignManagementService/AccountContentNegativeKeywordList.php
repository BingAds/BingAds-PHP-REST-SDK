...
class AccountContentNegativeKeywordList extends SharedList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AccountContentNegativeKeywordList';
