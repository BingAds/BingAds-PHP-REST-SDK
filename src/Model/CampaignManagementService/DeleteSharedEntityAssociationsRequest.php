...
class DeleteSharedEntityAssociationsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'DeleteSharedEntityAssociationsRequest';
