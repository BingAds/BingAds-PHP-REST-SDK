...
class SharedList extends SharedEntity implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const MAPPINGS = [
        ...
        'BrandList' => 'Microsoft\MsAds\Rest\Model\CampaignManagementService\BrandList',
        'NegativeKeywordList' => 'Microsoft\MsAds\Rest\Model\CampaignManagementService\NegativeKeywordList',
        'PlacementExclusionList' => 'Microsoft\MsAds\Rest\Model\CampaignManagementService\PlacementExclusionList',
    ];
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SharedList';
    ...
    */
    ...
    {
        if (!isset($this->container['ItemCount']) || is_null($this->container['ItemCount'])) {
            return null;
        }
