...
class GetBrandKitsByIdsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetBrandKitsByIdsRequest';
    ...
    */
     ...
     * @return string[]|null
     */
    public function getBrandKitIds()
    {
        if (!isset($this->container['BrandKitIds']) || is_null($this->container['BrandKitIds'])) {
            return null;
        }
        return $this->container['BrandKitIds'];
    }

    /**
     * Sets BrandKitIds
     *
     * @param string[]|null $BrandKitIds BrandKitIds
     *
     * @return self
     */
    public function setBrandKitIds($BrandKitIds)
    {
        if (is_null($BrandKitIds)) {
            array_push($this->openAPINullablesSetToNull, 'BrandKitIds');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('BrandKitIds', $nullablesSetToNull);
            if ($index !== FALSE) {
