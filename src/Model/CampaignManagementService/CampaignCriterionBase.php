...
class CampaignCriterionBase extends CampaignCriterion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CampaignCriterionBase';
