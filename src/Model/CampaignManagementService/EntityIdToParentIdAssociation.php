...
class EntityIdToParentIdAssociation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'EntityIdToParentIdAssociation';
