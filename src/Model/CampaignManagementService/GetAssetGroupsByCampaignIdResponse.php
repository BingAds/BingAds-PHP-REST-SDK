...
class GetAssetGroupsByCampaignIdResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetAssetGroupsByCampaignIdResponse';
