...
class GetSharedEntityAssociationsByEntityIdsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetSharedEntityAssociationsByEntityIdsRequest';
