...
class GetResponsiveAdRecommendationJobRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetResponsiveAdRecommendationJobRequest';
