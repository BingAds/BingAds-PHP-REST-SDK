...
class GetAudienceGroupsByIdsResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetAudienceGroupsByIdsResponse';
    ...
    protected static array $openAPITypes = [
        'AudienceGroups' => '\Microsoft\MsAds\Rest\Model\CampaignManagementService\AudienceGroup[]',
    ...
    */
     ...
     * Gets AudienceGroups
     *
     * @return \Microsoft\MsAds\Rest\Model\CampaignManagementService\AudienceGroup[]|null
     */
    public function getAudienceGroups()
    {
        if (!isset($this->container['AudienceGroups']) || is_null($this->container['AudienceGroups'])) {
            return null;
        }
     ...
     * Sets AudienceGroups
     *
     * @param \Microsoft\MsAds\Rest\Model\CampaignManagementService\AudienceGroup[]|null $AudienceGroups AudienceGroups
     *
     * @return self
     */
    public function setAudienceGroups($AudienceGroups)
    {
        if (is_null($AudienceGroups)) {
            array_push($this->openAPINullablesSetToNull, 'AudienceGroups');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('AudienceGroups', $nullablesSetToNull);
            if ($index !== FALSE) {
