...
class Setting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    /**
     * Gets AISearchEnabled
     *
     * @return bool|null
     */
    public function getAISearchEnabled()
    {
        if (!isset($this->container['AISearchEnabled']) || is_null($this->container['AISearchEnabled'])) {
            return null;
        }
        return $this->container['AISearchEnabled'];
    }

    /**
     * Sets AISearchEnabled
     *
     * @param bool|null $AISearchEnabled AISearchEnabled
     *
     * @return self
     */
    public function setAISearchEnabled($AISearchEnabled)
    {
        if (is_null($AISearchEnabled)) {
