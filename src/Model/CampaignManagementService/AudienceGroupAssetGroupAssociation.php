...
class AudienceGroupAssetGroupAssociation implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'AudienceGroupAssetGroupAssociation';
    ...
    */
    ...
    {
        if (!isset($this->container['AudienceGroupId']) || is_null($this->container['AudienceGroupId'])) {
            return null;
        }
     ...
     *
     * @param string|null $AudienceGroupId AudienceGroupId
     *
     * @return self
     */
