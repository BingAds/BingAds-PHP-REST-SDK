...
class BatchErrorCollection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const MAPPINGS = [
        'BatchErrorCollection' => 'Microsoft\MsAds\Rest\Model\CampaignManagementService\BatchErrorCollectionBase',
        'EditorialErrorCollection' => 'Microsoft\MsAds\Rest\Model\CampaignManagementService\EditorialErrorCollection',
    ];
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'BatchErrorCollection';
