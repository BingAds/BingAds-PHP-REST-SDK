...
class GetNegativeKeywordsByEntityIdsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetNegativeKeywordsByEntityIdsRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ParentEntityId', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (!isset($this->container['ParentEntityId']) || is_null($this->container['ParentEntityId'])) {
            return null;
        }
     ...
     * Sets ParentEntityId
     *
     * @param string|null $ParentEntityId ParentEntityId
     *
     * @return self
     */
    public function setParentEntityId($ParentEntityId)
    {
        if (is_null($ParentEntityId)) {
            array_push($this->openAPINullablesSetToNull, 'ParentEntityId');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ParentEntityId', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
