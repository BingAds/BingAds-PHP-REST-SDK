...
class ApplyCustomerListUserDataResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'ApplyCustomerListUserDataResponse';
