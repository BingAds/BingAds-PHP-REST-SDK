...
class HotelCheckInDateCriterion extends Criterion implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'HotelCheckInDateCriterion';
