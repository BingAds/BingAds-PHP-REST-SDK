...
class GetAccountMonthlySpendRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetAccountMonthlySpendRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('MonthYear', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (!isset($this->container['MonthYear']) || is_null($this->container['MonthYear'])) {
            return null;
        }
        return $this->container['MonthYear'];
    }

    /**
     * Sets MonthYear
     *
     * @param \DateTime|null $MonthYear MonthYear
     *
     * @return self
     */
    public function setMonthYear($MonthYear)
    {
        if (is_null($MonthYear)) {
            throw new \InvalidArgumentException('non-nullable MonthYear cannot be null');
        }
        $this->container['MonthYear'] = $MonthYear;
