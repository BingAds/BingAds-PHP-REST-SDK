...
class AccountAdditionalField
{
    ...
    public const TAX_CERTIFICATE = 'TaxCertificate';

    public const ACCOUNT_MODE = 'AccountMode';

    public const COUPON_CLAIM_INFO = 'CouponClaimInfo';
