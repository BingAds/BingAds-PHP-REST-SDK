...
class CheckFeatureAdoptionCouponEligibilityRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CheckFeatureAdoptionCouponEligibilityRequest';
    ...
    */
    ...
    public function setFeatureId($FeatureId)
    {
        if (is_null($FeatureId)) {
            throw new \InvalidArgumentException('non-nullable FeatureId cannot be null');
        }
