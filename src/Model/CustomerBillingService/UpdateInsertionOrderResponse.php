...
class UpdateInsertionOrderResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'UpdateInsertionOrderResponse';
    ...
    */
    ...
    public function setLastModifiedTime($LastModifiedTime)
    {
        if (is_null($LastModifiedTime)) {
            throw new \InvalidArgumentException('non-nullable LastModifiedTime cannot be null');
        }
