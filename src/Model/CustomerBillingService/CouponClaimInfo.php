...
class CouponClaimInfo implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CouponClaimInfo';
    ...
    */
    ...
    public function setClaimDate($ClaimDate)
    {
        if (is_null($ClaimDate)) {
            throw new \InvalidArgumentException('non-nullable ClaimDate cannot be null');
        }
