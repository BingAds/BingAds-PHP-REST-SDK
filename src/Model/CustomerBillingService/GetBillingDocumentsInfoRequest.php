...
class GetBillingDocumentsInfoRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetBillingDocumentsInfoRequest';
    ...
    protected static array $setters = [
        ...
        'EndDate' => 'setEndDate',
        'ReturnInvoiceNumber' => 'setReturnInvoiceNumber'
    ];
    ...
    protected static array $getters = [
        ...
        'EndDate' => 'getEndDate',
        'ReturnInvoiceNumber' => 'getReturnInvoiceNumber'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('ReturnInvoiceNumber', $data ?? [], null);
    }
    ...
    */
    ...
    /**
     * Gets ReturnInvoiceNumber
     *
     * @return bool|null
     */
    public function getReturnInvoiceNumber()
    {
        if (!isset($this->container['ReturnInvoiceNumber']) || is_null($this->container['ReturnInvoiceNumber'])) {
            return null;
        }
        return $this->container['ReturnInvoiceNumber'];
    }

    /**
     * Sets ReturnInvoiceNumber
     *
     * @param bool|null $ReturnInvoiceNumber ReturnInvoiceNumber
     *
     * @return self
     */
    public function setReturnInvoiceNumber($ReturnInvoiceNumber)
    {
        if (is_null($ReturnInvoiceNumber)) {
            array_push($this->openAPINullablesSetToNull, 'ReturnInvoiceNumber');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ReturnInvoiceNumber', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['ReturnInvoiceNumber'] = $ReturnInvoiceNumber;
