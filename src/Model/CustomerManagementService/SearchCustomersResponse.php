...
class SearchCustomersResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SearchCustomersResponse';
    ...
    protected static array $openAPITypes = [
        'Customers' => '\Microsoft\MsAds\Rest\Model\CustomerManagementService\Customer[]'
    ];
    ...
    */
    ...
    {
        if (!isset($this->container['Customers']) || is_null($this->container['Customers'])) {
            return null;
        }
     ...
     * Sets Customers
     *
     * @param \Microsoft\MsAds\Rest\Model\CustomerManagementService\Customer[]|null $Customers Customers
     *
     * @return self
     */
