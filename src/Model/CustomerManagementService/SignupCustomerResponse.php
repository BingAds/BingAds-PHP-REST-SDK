...
class SignupCustomerResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'SignupCustomerResponse';
    ...
    */
    ...
    {
        if (!isset($this->container['CustomerNumber']) || is_null($this->container['CustomerNumber'])) {
            return null;
        }
    ...
    public function setCustomerNumber($CustomerNumber)
    {
        if (is_null($CustomerNumber)) {
            array_push($this->openAPINullablesSetToNull, 'CustomerNumber');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('CustomerNumber', $nullablesSetToNull);
            if ($index !== FALSE) {
