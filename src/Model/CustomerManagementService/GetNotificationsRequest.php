...
class GetNotificationsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'GetNotificationsRequest';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('TypeIds', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (!isset($this->container['TypeIds']) || is_null($this->container['TypeIds'])) {
            return null;
        }
     ...
     * Sets TypeIds
     *
     * @param int[]|null $TypeIds TypeIds
     *
     * @return self
     */
    ...
    {
        if (is_null($TypeIds)) {
            array_push($this->openAPINullablesSetToNull, 'TypeIds');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('TypeIds', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
