...
class KeyValuePairOfstringAndstring implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'KeyValuePairOfstringAndstring';
