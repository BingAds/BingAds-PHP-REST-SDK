...
class KeyValuePairOfstringAndByteArray implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'KeyValuePairOfstringAndByteArray';
