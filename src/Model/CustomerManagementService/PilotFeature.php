...
class PilotFeature implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'PilotFeature';
    ...
    */
    ...
    {
        if (!isset($this->container['Countries']) || is_null($this->container['Countries'])) {
            return null;
        }
