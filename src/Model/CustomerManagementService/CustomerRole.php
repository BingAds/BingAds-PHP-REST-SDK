...
class CustomerRole implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'CustomerRole';
    ...
    protected static array $setters = [
        ...
        'LinkedAccountIds' => 'setLinkedAccountIds',
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('LinkedAccountIds', $data ?? [], null);
    ...
    */
    ...
    /**
     * Gets LinkedAccountIds
     *
     * @return string[]|null
     */
    public function getLinkedAccountIds()
    {
        if (!isset($this->container['LinkedAccountIds']) || is_null($this->container['LinkedAccountIds'])) {
            return null;
        }
        return $this->container['LinkedAccountIds'];
    }

    /**
     * Sets LinkedAccountIds
     *
     * @param string[]|null $LinkedAccountIds LinkedAccountIds
     *
     * @return self
     */
    public function setLinkedAccountIds($LinkedAccountIds)
    {
        if (is_null($LinkedAccountIds)) {
            array_push($this->openAPINullablesSetToNull, 'LinkedAccountIds');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('LinkedAccountIds', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['LinkedAccountIds'] = $LinkedAccountIds;
