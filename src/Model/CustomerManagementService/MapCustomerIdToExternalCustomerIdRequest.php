...
class MapCustomerIdToExternalCustomerIdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'MapCustomerIdToExternalCustomerIdRequest';
    ...
    */
    ...
    {
        if (!isset($this->container['ExternalCustomerId']) || is_null($this->container['ExternalCustomerId'])) {
            return null;
        }
     ...
     *
     * @param string|null $ExternalCustomerId ExternalCustomerId
     *
     * @return self
     */
    public function setExternalCustomerId($ExternalCustomerId)
    {
        if (is_null($ExternalCustomerId)) {
            array_push($this->openAPINullablesSetToNull, 'ExternalCustomerId');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ExternalCustomerId', $nullablesSetToNull);
            if ($index !== FALSE) {
