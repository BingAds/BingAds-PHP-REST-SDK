...
class PersonName implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('MiddleInitial', $data ?? [], null);
    }
    ...
    */
    ...
    {
        if (!isset($this->container['MiddleInitial']) || is_null($this->container['MiddleInitial'])) {
            return null;
        }
     ...
     * Sets MiddleInitial
     *
     * @param string|null $MiddleInitial MiddleInitial
     *
     * @return self
     */
    public function setMiddleInitial($MiddleInitial)
    {
        if (is_null($MiddleInitial)) {
            array_push($this->openAPINullablesSetToNull, 'MiddleInitial');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('MiddleInitial', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
