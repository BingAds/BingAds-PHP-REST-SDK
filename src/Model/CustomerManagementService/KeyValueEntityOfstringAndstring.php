...
class KeyValueEntityOfstringAndstring implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static string $openAPIModelName = 'KeyValueEntityOfstringAndstring';
